    ...
    return (
      <button
        ...
        className={cn(
          ...
          checked ? "bg-primary border-foreground" : "bg-muted border-border",
          className
        )}
        ref={ref}
        {...props}
      >
        <span
          className={cn(
            "pointer-events-none block h-4 w-4 rounded-full bg-white transition-transform border border-foreground",
